...
import { AnimatePauseIcon, AnimatePlayIcon, ArrowDownIcon, CloseIcon, DeleteIcon, DownloadIcon, EmptyIcon, FaMinusSquareOIcon, LoadIcon, LoopIcon, LyricIcon, NextAudioIcon, OrderPlayIcon, PlayListsIcon, PrevAudioIcon, ReloadIcon, RepeatIcon, ShufflePlayIcon, VolumeMuteIcon, VolumeUnmuteIcon, AddIcon, DotsIcon, CartIcon, RandomIcon } from './components/Icon';
...
var DEFAULT_ICON = {
  ...
  add: /*#__PURE__*/React.createElement(AddIcon, null),
  dots: /*#__PURE__*/React.createElement(DotsIcon, null),
  cart: /*#__PURE__*/React.createElement(CartIcon, null),
  random: /*#__PURE__*/React.createElement(RandomIcon, null)
};
...
var ReactJkMusicPlayer = /*#__PURE__*/function (_PureComponent) {
  ...
  function ReactJkMusicPlayer(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderLoopIcon", function (playMode) {
      ...
      return /*#__PURE__*/cloneElement(_this.iconMap.loop, animateProps);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "renderRandomIcon", function (playMode) {
      ...
      return /*#__PURE__*/cloneElement(_this.iconMap.random, animateProps);
    });
  ...
  _createClass(ReactJkMusicPlayer, [{
    ...
    value: function render() {
      ...
      var LoopModeComponent = /*#__PURE__*/React.createElement("span", {
        className: cls("group loop-btn ".concat(currentPlayMode === 'singleLoop' ? 'font-acent' : '')),
        onClick: this.toggleLoopMode,
        title: locale.playModeText['singleLoop']
      }, this.renderLoopIcon(currentPlayMode));
      var RandomModeComponent = /*#__PURE__*/React.createElement("span", {
        className: cls("group loop-btn ".concat(currentPlayMode === 'shufflePlay' ? 'font-acent' : '')),
      ...
      return /*#__PURE__*/createPortal( /*#__PURE__*/React.createElement("div", {
        ...
        title: audioTitle
      }, this.renderAudioTitle()), /*#__PURE__*/React.createElement("span", {
        className: "audio-subtitle",
        title: audioSubtitle
      }, this.renderAudioSubtitle())), /*#__PURE__*/React.createElement("div", {
        className: "audio-add"
      }, this.iconMap.add), /*#__PURE__*/React.createElement("div", {
        className: "audio-dots-menu"
      }, this.iconMap.dots), /*#__PURE__*/React.createElement("div", {
      ...
      }, sliderBaseOptions))), LyricComponent, /*#__PURE__*/React.createElement("span", {
        className: "group audio-lists-btn",
        title: locale.playListsText,
        onClick: this.openAudioListsPanel
      }, this.iconMap.playLists), toggleMode && /*#__PURE__*/React.createElement("span", {
